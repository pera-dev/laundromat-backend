package com.laundromat.app.config.timezone;

import com.laundromat.app.LaundromatApp;
import com.laundromat.app.repository.timezone.DateTimeWrapper;
import com.laundromat.app.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM laundro_date_time_wrapper where id=%d", fieldName, id);
    }
